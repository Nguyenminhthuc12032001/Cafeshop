                ...
                <div class="lg:sticky lg:top-24 space-y-4">
                    <div>
                        ...
                        <div class="swiper featuredSwiper p-4 sm:p-5" aria-label="Featured items slider">
                                ...
                                @forelse($featured as $item)
                                    ...
                                    <div class="swiper-slide">
                                        ...
                                        <article
                                            ...
                                            {{-- top image small (optional nhÆ°ng Apple ráº¥t hay dÃ¹ng) --}}
                                            <div class="relative overflow-hidden bg-black/20 w-full"
                            ...
                            {{-- Controls --}}
                            <button
                                class="featuredPrev absolute left-2 top-1/2 z-20 -translate-y-1/2 w-9 h-9 rounded-full bg-black/45 border border-white/20 text-white grid place-items-center hover:bg-black/60 transition"
                                type="button" aria-label="Previous featured slide">
                            ...
                            <button
                                class="featuredNext absolute right-2 top-1/2 z-20 -translate-y-1/2 w-9 h-9 rounded-full bg-black/45 border border-white/20 text-white grid place-items-center hover:bg-black/60 transition"
                                type="button" aria-label="Next featured slide">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M9 5l7 7-7 7" />
                                </svg>
                            </button>
                            <div class="featuredPagination swiper-pagination mt-3"></div>
                        </div>
                    </div>
