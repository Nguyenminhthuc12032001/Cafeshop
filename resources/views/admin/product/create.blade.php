                ...
                <div x-data="productVariantsEditor({
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Price
                                    (&#8363;)</label>
                                <input type="number" step="0.01" name="price" :disabled="hasVariants" value="{{ old('price') }}"
                                    class="w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600
                           bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-gray-100
                           focus:ring-2 focus:ring-primary focus:outline-none transition"
                                    placeholder="0.00">
                            ...
                            <div>
                                ...
                                <input type="number" name="stock" :disabled="hasVariants" value="{{ old('stock') }}"
                                    class="w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600
                           bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-gray-100
                           focus:ring-2 focus:ring-primary focus:outline-none transition"
                                    placeholder="0">
                    ...
                    <div x-show="hasVariants" x-transition.opacity class="space-y-4">
                        <div>
                            ...
                            <input type="number" step="0.01" name="price" :disabled="!hasVariants"
                                value="{{ old('price') }}"
                                class="w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600
                           bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-gray-100
                           focus:ring-2 focus:ring-primary focus:outline-none transition"
                                placeholder="Giá gốc của sản phẩm (fallback khi variant không có giá)">
                        </div>
