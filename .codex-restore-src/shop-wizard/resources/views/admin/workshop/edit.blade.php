            ...
            <div
                ...
                <form action="{{ route('admin.workshop.update', $workshop->id) }}" method="POST"
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="5"
                            class="w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600 
                                   ...
                                   focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 
                                   focus:outline-none transition-all duration-300"
                            placeholder="Write workshop description...">{{ old('description', $workshop->description) }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" name="price" value="{{ old('price', $workshop->price) }}"
                            class="w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600 
                                   bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-gray-100
                                   focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 
                                   focus:outline-none transition-all duration-300"
                    ...
                    {{-- Workshop Image (Logic chuẩn như Featured Image) --}}
                    <div x-data="productMainImageUpload({ maxMB: 5, initialUrl: @js($workshop->image ?? null) })">
               ...
               hover:bg-blue-50 dark:hover:bg-gray-600 group">
                           ...
                           group-hover:bg-blue-100 transition-colors">
                                    ...
                                    <p class="text-gray-600 dark:text-gray-300 font-medium mb-1">Upload Workshop Image
                                    </p>
