<x-app-layout>
    ...
    <div class="max-w-4xl mx-auto py-12 px-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-md border border-gray-100 dark:border-gray-700 p-8">
            <h3 class="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-6">Workshop Registration Details</h3>

            <form action="{{ route('admin.workshop_registrations.store') }}" method="POST" class="space-y-6">
                @csrf

                {{-- Workshop ID --}}
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Workshop</label>
